...
<div className="p-2 border-b border-gray-800">
  <div className={`flex items-center justify-center ${sidebarOpen ? 'gap-3' : ''}`}>
    <div className={`rounded-xl flex items-center justify-center flex-shrink-0 overflow-hidden transition-all duration-300 ${sidebarOpen ? 'w-40 h-40' : 'w-10 h-10'}`}>
      <img
        src={logo}
        alt="Phoenix Logo"
